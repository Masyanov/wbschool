        ...
        <div class="container">
            ...
            <div class="materials__wrapper">
                ...
                <ul class="materials-block">
                    <? $postsMain = carbon_get_theme_option('posts-free_association');?>
                    ...
                    <li class="materials-block__item materials-block__item--big">
                        <article class="card-article card-article--big">
                            ...
                            <div class="card-article__text-content"><a>
                                ...
                                <p class="card-article__description"><? echo carbon_get_post_meta($post['id'], 'post-details-mini-desc'); ?></p>
                                <ul class="card-article__authors">
                                    ...
                                    <li class="card-article__author">
                                        ...
                                        <p class="card-article__author-name"><?= get_the_title($speak['id']) ?></p></a>
                                    </li>
                                    <? endforeach; ?>
                                </ul>
                        ...
                        <li class="materials-block__item">
                            <article class="card-article">
                                ...
                                <div class="card-article__text-content"><a>
                                    ...
                                    <p class="card-article__description"><? echo carbon_get_post_meta($home_post->ID, 'post-details-mini-desc'); ?></p>
                                    <ul class="card-article__authors">
