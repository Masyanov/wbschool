...
/* harmony import */ var _modules_removes_focus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/removes-focus */ "./js/modules/removes-focus.js");
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu */ "./js/modules/menu.js");
/* harmony import */ var _modules_slider_init_feedback_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/init-feedback-slider */ "./js/modules/slider/init-feedback-slider.js");
/* harmony import */ var _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider/main-slider */ "./js/modules/slider/main-slider.js");
/* harmony import */ var _modules_slider_video_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/video-slider */ "./js/modules/slider/video-slider.js");
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");
/* harmony import */ var _modules_slider_init_reviews_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/slider/init-reviews-slider */ "./js/modules/slider/init-reviews-slider.js");
/* harmony import */ var _modules_slider_card_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/slider/card-slider */ "./js/modules/slider/card-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_2__["openMenu"])();
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_6__["initVideo"])(); // Utils
  // ---------------------------------

  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])(); // Modules
  // ---------------------------------

  Object(_modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_4__["initMainSlider"])();
  Object(_modules_slider_video_slider__WEBPACK_IMPORTED_MODULE_5__["initVideoSlider"])();
  Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_9__["initTabs"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_removes_focus__WEBPACK_IMPORTED_MODULE_1__["removesFocus"])();
    Object(_modules_slider_init_feedback_slider__WEBPACK_IMPORTED_MODULE_3__["initFeedbackSlider"])();
    Object(_modules_slider_init_reviews_slider__WEBPACK_IMPORTED_MODULE_7__["initReviewsSlider"])();
    Object(_modules_slider_card_slider__WEBPACK_IMPORTED_MODULE_8__["initCardsSlider"])();
    Object(_modules_slider_video_slider__WEBPACK_IMPORTED_MODULE_5__["initVideoSlider"])();
    Object(_modules_map__WEBPACK_IMPORTED_MODULE_10__["initMap"])();
...
var initMap = function initMap() {
  ...
  ymaps.ready(function () {
    ...
    myMap.events.add('touch', function () {
      if (myMap.balloon.isOpen()) {
        myMap.balloon.close();
      }
    });
...
var openMenu = function openMenu() {
  if (document.querySelector('.main-nav')) {
    ...
    var textOpen = toggle.getAttribute('data-text-open');
    var textClose = toggle.getAttribute('data-text-close');
    var scroll = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();
...
/***/ "./js/modules/removes-focus.js":
/*!*************************************!*\
  !*** ./js/modules/removes-focus.js ***!
  \*************************************/
/*! exports provided: removesFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removesFocus", function() { return removesFocus; });
var removesFocus = function removesFocus() {
...
/***/ "./js/modules/slider/card-slider.js":
/*!******************************************!*\
  !*** ./js/modules/slider/card-slider.js ***!
  \******************************************/
/*! exports provided: initCardsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCardsSlider", function() { return initCardsSlider; });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants */ "./js/constants.js");


var initCardsSlider = function initCardsSlider() {
  var cardsSlider = document.querySelector('.article__recommend-slider');
  var swiper;
  ...
  var initSlider = function initSlider() {
    ...
    var nextBtn = cardsSlider.querySelector('.article__recommend-button--next');
    var prevBtn = cardsSlider.querySelector('.article__recommend-button--prev');
  ...
  var breakpoint = window.matchMedia("(max-width: 1439px) and (min-width: 767px)");
...
/***/ "./js/modules/slider/init-feedback-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/slider/init-feedback-slider.js ***!
  \***************************************************/
/*! exports provided: initFeedbackSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initFeedbackSlider = function initFeedbackSlider() {
  var feedbackSlider = document.querySelector('[data-feedback-slider]');
  var feedbackSwiper;
...
/***/ "./js/modules/slider/main-slider.js":
/*!******************************************!*\
  !*** ./js/modules/slider/main-slider.js ***!
  \******************************************/
...
function initMainSlider() {
  var sliderProcess = document.querySelector('.process__slider');
  ...
  var slider = new Swiper(sliderProcess, {
    a11y: {
      enabled: true,
...
/***/ "./js/modules/slider/video-slider.js":
/*!*******************************************!*\
  !*** ./js/modules/slider/video-slider.js ***!
  \*******************************************/
/*! exports provided: initVideoSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initVideoSlider", function() { return initVideoSlider; });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../constants */ "./js/constants.js");

var videoSlider = document.querySelector('.video-slider');

var initSlider = function initSlider(slider) {
  var nextBtn = slider.querySelector('.video-slider__button--next');
  var prevBtn = slider.querySelector('.video-slider__button--prev');
...
var initVideo = function initVideo() {
  ...
  document.addEventListener('click', function (evt) {
    ...
    if (video) {
      ...
      var player = video.querySelector('iframe');
      var cover = video.querySelector('.video__cover');
